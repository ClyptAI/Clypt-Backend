...
SG_LAUNCH_PROFILE="${SG_LAUNCH_PROFILE_OVERRIDE:-${SG_LAUNCH_PROFILE:-final}}"
...
SG_MAMBA_SCHEDULER_STRATEGY="${SG_MAMBA_SCHEDULER_STRATEGY:-no_buffer}"
...
declare -a args=(
  ...
  -e "SGLANG_USE_AITER=$SG_USE_AITER"
  -e "SGLANG_ROCM_DISABLE_LINEARQUANT=1"
  -e "SGLANG_ENABLE_QUARK_QUANTIZATION=0"
