...
from backend.runtime.phase26_worker_app import build_default_phase26_worker_service
...
def main() -> None:
    ...
    service = build_default_phase26_worker_service()
    worker_id = os.environ.get("CLYPT_PHASE24_LOCAL_WORKER_ID", "phase26-worker")
