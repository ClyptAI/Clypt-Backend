...
This document captures canonical, already-validated run references and key outputs. It is used as a baseline during infra/runtime changes and comments-trends evolution.
...
| Longer clip stress reference | `joeroganflagrant.mp4` | 788.7s | 201 | 285s | incomplete | incomplete | Phase 3 hit 429 |
...
## 3) Recorded Phase 2-4 Timing Snapshots

### 3.1 Queue baseline (`job_430a676441ab42af8a43a25d190dbc13`)
...
### 3.2 Queue benchmark rerun (`run_20260409_1517_phase24_bench`)
...
### 3.3 Tuned queue replay (`run_20260409_175717_phase24_dispatch`)
...
## 4) Candidate Snapshot References

### 4.1 Successful mrbeast run (ranked excerpt)
...
### 4.2 Tuned queue replay (`run_20260409_175717_phase24_dispatch`)
