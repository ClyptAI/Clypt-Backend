"""Tests for the RTX-side node-media-prep runner."""
...
from backend.runtime.phase1_audio_service.node_media_prep import (
...
def test_run_node_media_prep_invokes_ffmpeg_for_each_node(
    ...
    # local_path should NOT be surfaced to the caller (clips are ephemeral on the RTX box).
